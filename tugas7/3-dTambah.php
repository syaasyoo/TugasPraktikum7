  ...
  <body>
    ...
    <div class="container pt-2 pb-2">
      ...
      <div class="d-flex justify-content-center pt-3 pb-3">
        <h1 class="fw-bolder">Add New Department</h1>
      </div>
    <!-- Akhir Keterangan --> 
    ...
    <!-- Formulir -->
      <form action="" method ="post" enctype="multipart/form-data" class="row g-3">
        <div class="mb-2">
          ...
          <input class="form-control" type="text" name="department_name" id="department_name" required autocomplete ="off">  
        </div>
        <div class="mb-2">
          <label for="department_loc" class="form-label">Department Location</label>
          <input class="form-control" type="text" name="department_loc" id="department_loc" required autocomplete ="off">  
        </div>
